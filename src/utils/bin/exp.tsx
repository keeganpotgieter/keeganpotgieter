...
export const experience = async () => {
  return (
    <div className='flex flex-col gap-2 rounded-md text-sm'>
      ...
      <div className='mb-2'>
        <div className='group flex items-center justify-between text-xl font-semibold'>
          <span>necta</span>
          <a
            href='https://necta.app'
            target='_blank'
            rel='noopener noreferrer'
            className='hover:gradient-text transform transition-all group-hover:-rotate-45'
          >
            {'->'}
          </a>
        </div>
        <p className='role mb-1 mt-1 p-1 italic'>
      ...
      <BorderAnimate className='mb-2 border-border/20'>
        {/* <div className='h-[1px] w-full bg-white'></div> */}
        <div className='group flex items-center justify-between text-lg'>
          <div>Currently at: Subi</div>
          <a
            href='https://subi.au'
            target='_blank'
            rel='noopener noreferrer'
            className='group-hover:gradient-text transform transition-all group-hover:-rotate-45'
          >
            {'->'}
          </a>
        </div>
