...
const content = html`
  <div class="flex flex-col gap-4 !whitespace-normal rounded-md text-sm">
    <h1 class="mb-4 text-2xl font-bold">Experience</h1>

    <div class="mb-4">
      <div
        class="group flex items-center justify-between text-xl font-semibold"
      >
        <span>necta</span>
        <a
          ...
          class="hover:gradient-text transform transition-all group-hover:-rotate-45"
          >-></a
        >
      </div>
      <p class="role mb-1 mt-1 p-1 italic">
        Creator necta Web Application (2022 - Present)
      </p>
      <ul class="list-inside list-disc space-y-2 opacity-70">
        <li>
        ...
        <li>
          Implemented full-stack development practices, utilising Python, Django
    ...
    <div class="mb-2">
      <div class="text-xl font-semibold">Windy Hills Farm</div>
      <div class="role mb-1 mt-1 italic">
    ...
    <div class="mb-2">
      <div class="text-xl font-semibold">TenantsReview</div>
      <div class="role mb-1 mt-1 italic">
      ...
      <ul class="list-inside list-disc space-y-2 opacity-70">
        ...
        <li>
          Introduced a watchlist feature and overhauled frontend UI using React,
    ...
    <div class="mb-2">
      <div class="text-xl font-semibold">Betfair Australia</div>
      <div class="role mb-1 mt-1 italic">
      ...
      <ul class="list-inside list-disc space-y-2 opacity-70">
        ...
        <li>
          Developed and backtested trading models on racing markets, leading to
          top three placement within the scholarship group, and an extended
          $10,000 offer with a private firm.
        </li>
        <li>
          Utilised Python, NumPy, Pandas, scikit-learn for machine learning and
          data analysis tasks.
        </li>
        <li>
    ...
    <div class="mb-2">
      <div class="text-xl font-semibold">Betalytics</div>
      <div class="role mb-1 mt-1 italic">
